...
cp ../models/<DATA_MODEL_NAME>.model ${SLURM_SCRATCH}
cp ../models/<GEN_MODEL_NAME>.model ${SLURM_SCRATCH}
cp ../models/<DISC_MODEL_NAME>.model ${SLURM_SCRATCH}
cp ../solvers/<SOLVER_NAME>.solver ${SLURM_SCRATCH}
