...
python3 <LIGAN_DIR>/generate.py --data_model ../<MODEL_DIR>/<DATA_MODEL_NAME>.model --gen_model ../<MODEL_DIR>/<GEN_MODEL_NAME>.model --gen_weights ../<WEIGHTS_DIR>/${GEN_WEIGHTS_NAME}.caffemodel -r ${REC} -l ${LIG} --data_root <DATA_ROOT> -b lig -b lig_gen --fit_atoms --output_sdf --output_channels --verbose 3 --gpu <GEN_OPTIONS> --n_samples <N_SAMPLES> --atom_init <ATOM_INIT> --r_factor <R_FACTOR> --beam_size <BEAM_SIZE> --beam_stride <BEAM_STRIDE> --learning_rate <LEARNING_RATE> --beta1 <BETA1> --beta2 <BETA2> --weight_decay <WEIGHT_DECAY> --interm_iters <INTERM_ITERS> --final_iters <FINAL_ITERS> -o <JOB_NAME>_${SLURM_ARRAY_TASK_ID}
exit
