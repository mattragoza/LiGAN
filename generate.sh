...
TARGET=1ajv
BASE_FLAGS="-d ${GAN}/data*.model -g ${GAN}/${GEN}.model -w ${GAN}/${GAN}.${DATA}.0.${FOLD}_gen_iter_${ITER}.caffemodel -r ${TARGET}/${TARGET}_rec.gninatypes -l ${TARGET}/${TARGET}_ligand_0.gninatypes --data_file 10.types --data_root ${ROOT} --gpu --fit_atom_types"

python generate.py ${BASE_FLAGS} -o ${NAME}/post_sample  --n_samples 10
