...
python generate.py ${BASE_FLAGS} -b lig_gen -b lig -o ${NAME}_POST_SAMPLE  --n_samples 10 --fit_atom_types --output_sdf
...
echo load ../../dkoes/PDBbind/refined-set/${TARGET}/${TARGET}_rec.pdb >> ${NAME}.pymol
echo load ../../dkoes/PDBbind/refined-set/${TARGET}/${TARGET}_min.sdf >> ${NAME}.pymol
