...
class TestLossFunction(object):
    ...
    def test_loss_recon0(self, loss_fn):
        ...
        assert loss.item() == 0
        assert losses == dict(loss=0, recon_loss=0)
    ...
    def test_loss_recon1(self, loss_fn):
        ...
        assert loss.item() == 5
        assert losses == dict(loss=5, recon_loss=5)
    ...
    def test_loss_kldiv0(self, loss_fn):
        ...
        assert loss.item() == 0
        assert losses == dict(loss=0, kldiv_loss=0)
    ...
    def test_loss_kldiv1(self, loss_fn):
        ...
        assert loss.item() == 0
        assert losses == dict(loss=0, kldiv_loss=5)
    ...
    def test_loss_gan0(self, loss_fn):
        ...
        assert loss.item() == 0
        assert losses == dict(loss=0, gan_loss=0)
    ...
    def test_loss_gan1(self, loss_fn):
        ...
        assert losses == dict(loss=100, gan_loss=10)
    ...
    def test_loss_steric0(self, loss_fn):
        ...
        assert loss.item() == 0
        assert losses == dict(loss=0, steric_loss=0)
    ...
    def test_loss_steric1(self, loss_fn):
        ...
        assert loss.item() == -100
        assert losses == dict(loss=-100, steric_loss=100)
